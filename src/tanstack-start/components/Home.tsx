  ...
  return (
    <div className="home">
      <div className="home-hero">
        ...
        <h1>
          <span className="hero-accent">TanStack Start</span> を
          <br />
          ゼロから学ぶ
        </h1>
        <p className="hero-sub">
          インタラクティブなデモと解説で、型安全なルーティングと SSR を備えたフルスタックフレームワークを10レッスンでマスター。
          環境構築不要、今すぐ始められます。
        </p>
      ...
      <div className="home-features">
        <div className="feature-card">
          ...
          <h3>型安全</h3>
          <p>ルート・パラメータ・Server Functions まで TypeScript で守られます。</p>
        </div>
        <div className="feature-card">
          <span className="feature-icon">📖</span>
          <h3>日本語で解説</h3>
