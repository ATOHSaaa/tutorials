  ...
  return (
    <div className="home">
      <div className="home-hero">
        ...
        <h1>
          <span className="hero-accent">Search Engine Optimization</span>
          入門
        </h1>
        <p className="hero-sub">メタデータ、構造化データ、Core Web Vitals、SSR の SEO まで。検索エンジンに評価されるサイトを10レッスンで学びます。</p>
      ...
      <div className="home-features">
        <div className="feature-card">
          ...
          <h3>インタラクティブ</h3>
          <p>メタタグと構造化データのプレビューをデモで確認できます。</p>
        </div>
        <div className="feature-card">
          <span className="feature-icon">📖</span>
          <h3>日本語で解説</h3>
