  ...
  return (
    <div className="home">
      <div className="home-hero">
        ...
        <h1>
          <span className="hero-accent">Vite</span> を
          <br />
          ゼロから学ぶ
        </h1>
        <p className="hero-sub">高速な開発サーバーとビルドツール。React や TypeScript プロジェクトの土台として Vite を10レッスンで学びます。</p>
