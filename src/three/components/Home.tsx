  ...
  return (
    <div className="home">
      <div className="home-hero">
        ...
        <h1>
          <span className="hero-accent">Three.js</span>
          入門
        </h1>
        <p className="hero-sub">WebGL を手軽に使える 3D ライブラリ。シーン・カメラ・ライトから React Three Fiber まで10レッスンで学びます。</p>
      ...
      <div className="home-features">
        <div className="feature-card">
          ...
          <h3>インタラクティブ</h3>
          <p>3D の基本概念をインタラクティブなデモで体験できます。</p>
        </div>
        <div className="feature-card">
          <span className="feature-icon">📖</span>
          <h3>日本語で解説</h3>
