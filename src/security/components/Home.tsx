  ...
  return (
    <div className="home">
      <div className="home-hero">
        ...
        <h1>
          <span className="hero-accent">Web Security</span>
          入門
        </h1>
        <p className="hero-sub">XSS、CSRF、SQL インジェクション、HTTPS、セキュリティヘッダーまで。攻撃手法と防御策を10レッスンで学びます。</p>
      ...
      <div className="home-features">
        <div className="feature-card">
          ...
          <h3>インタラクティブ</h3>
          <p>脆弱性のあるコードと安全なコードの比較をデモで確認できます。</p>
        </div>
        <div className="feature-card">
          <span className="feature-icon">📖</span>
          <h3>日本語で解説</h3>
