  ...
  return (
    <div className="home">
      <div className="home-hero">
        ...
        <h1>
          <span className="hero-accent">Tauri</span> を
          <br />
          ゼロから学ぶ
        </h1>
        <p className="hero-sub">Rust バックエンドと Web フロントで軽量なデスクトップアプリを作る Tauri を10レッスンで学びます。</p>
      ...
      <div className="home-features">
        <div className="feature-card">
          ...
          <h3>インタラクティブ</h3>
          <p>Electron との違いやコマンドの流れをデモで確認できます。</p>
        </div>
        <div className="feature-card">
          <span className="feature-icon">📖</span>
          <h3>日本語で解説</h3>
