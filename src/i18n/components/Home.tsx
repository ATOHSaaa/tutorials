  ...
  return (
    <div className="home">
      <div className="home-hero">
        ...
        <h1>
          <span className="hero-accent">Internationalization</span>
          入門
        </h1>
        <p className="hero-sub">next-intl、react-i18next、多言語ルーティング、複数形・日付フォーマットまで。国際化を10レッスンで学びます。</p>
