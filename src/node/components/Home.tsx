  ...
  return (
    <div className="home">
      <div className="home-hero">
        ...
        <h1>
          <span className="hero-accent">Node.js</span>
          入門
        </h1>
        <p className="hero-sub">JavaScript をサーバー側で動かす Node.js。ファイル操作から HTTP サーバーまで10レッスンで学びます。</p>
      ...
      <div className="home-features">
        <div className="feature-card">
          ...
          <h3>インタラクティブ</h3>
          <p>イベントループや非同期処理の流れをデモで体験できます。</p>
        </div>
        <div className="feature-card">
          <span className="feature-icon">📖</span>
          <h3>日本語で解説</h3>
