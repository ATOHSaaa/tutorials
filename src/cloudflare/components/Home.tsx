  ...
  return (
    <div className="home">
      <div className="home-hero">
        ...
        <h1>
          <span className="hero-accent">Cloudflare</span> 入門
        </h1>
        <p className="hero-sub">
          Workers・D1・R2 を中心に、エッジで動くフルスタック開発を10レッスンで学びます。
          環境構築不要、今すぐ始められます。
        </p>
      ...
      <div className="home-features">
        <div className="feature-card">
          ...
          <h3>エッジで動く</h3>
          <p>Workers で世界中の CDN 上でコードを実行する仕組みを学べます。</p>
        </div>
        <div className="feature-card">
          <span className="feature-icon">🗄</span>
          <h3>D1 + R2</h3>
          <p>SQL データベースとオブジェクトストレージを Workers から使う方法を学べます。</p>
        </div>
        <div className="feature-card">
          <span className="feature-icon">💾</span>
          <h3>進捗を保存</h3>
