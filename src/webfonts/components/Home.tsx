  ...
  return (
    <div className="home">
      <div className="home-hero">
        ...
        <h1>
          <span className="hero-accent">Webフォント</span> を
          <br />
          ゼロから学ぶ
        </h1>
        <p className="hero-sub">Google Fonts からセルフホスティングまで。美しい文字とパフォーマンスの両立を10レッスンで学びます。</p>
      ...
      <div className="home-features">
        <div className="feature-card">
          ...
          <h3>インタラクティブ</h3>
          <p>font-display や読み込みの違いをデモで比較できます。</p>
        </div>
        <div className="feature-card">
          <span className="feature-icon">📖</span>
          <h3>日本語で解説</h3>
