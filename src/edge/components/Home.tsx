  ...
  return (
    <div className="home">
      <div className="home-hero">
        ...
        <h1>
          <span className="hero-accent">エッジコンピューティング</span> 入門
        </h1>
        <p className="hero-sub">
          CDN・エッジ関数・レイテンシの基礎を10レッスンで学びます。
          クラウドとの使い分けを理解し、次のステップで Cloudflare を実践しましょう。
        </p>
      ...
      <div className="home-features">
        <div className="feature-card">
          ...
          <h3>インタラクティブ</h3>
          <p>レイテンシやキャッシュの違いをデモで体験できます。</p>
        </div>
        <div className="feature-card">
          <span className="feature-icon">📖</span>
          <h3>日本語で解説</h3>
          <p>CDN・エッジ関数・データの使い分けをわかりやすく解説します。</p>
        </div>
        <div className="feature-card">
          <span className="feature-icon">💾</span>
          <h3>進捗を保存</h3>
