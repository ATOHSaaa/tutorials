  ...
  return (
    <div className="home">
      <div className="home-hero">
        ...
        <h1>
          <span className="hero-accent">HTTP / Web API</span>
          入門
        </h1>
        <p className="hero-sub">ブラウザとサーバーがどう通信するかを、HTTP の仕組みから REST API まで10レッスンで学びます。</p>
      ...
      <div className="home-features">
        <div className="feature-card">
          ...
          <h3>インタラクティブ</h3>
          <p>リクエスト・レスポンスの流れやステータスコードをデモで確認できます。</p>
        </div>
        <div className="feature-card">
          <span className="feature-icon">📖</span>
          <h3>日本語で解説</h3>
