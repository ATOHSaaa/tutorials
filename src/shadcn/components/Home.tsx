  ...
  return (
    <div className="home">
      <div className="home-hero">
        ...
        <h1>
          <span className="hero-accent">shadcn/ui</span>
          入門
        </h1>
        <p className="hero-sub">Radix UI + Tailwind CSS で、コピー＆ペースト可能な UI コンポーネントを構築する方法を10レッスンで学びます。</p>
      ...
      <div className="home-features">
        <div className="feature-card">
          ...
          <h3>インタラクティブ</h3>
          <p>Button・Dialog・Dropdown など、shadcn/ui 風のコンポーネントをデモで体験できます。</p>
        </div>
        <div className="feature-card">
          <span className="feature-icon">📖</span>
          <h3>日本語で解説</h3>
