  ...
  return (
    <div className="home">
      <div className="home-hero">
        ...
        <h1>
          <span className="hero-accent">Docker Containers</span>
          入門
        </h1>
        <p className="hero-sub">イメージ、コンテナ、Dockerfile、Compose まで。開発環境の統一とデプロイを10レッスンで学びます。</p>
