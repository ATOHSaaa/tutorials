  ...
  return (
    <div className="home">
      <div className="home-hero">
        ...
        <h1>
          <span className="hero-accent">Canvas</span>
          入門
        </h1>
        <p className="hero-sub">HTML5 Canvas で図形・テキスト・画像を描画し、アニメーションまで。2D グラフィックスの基礎を10レッスンで学びます。</p>
      ...
      <div className="home-features">
        <div className="feature-card">
          ...
          <h3>インタラクティブ</h3>
          <p>実際の Canvas 上で図形やアニメーションを描くデモが体験できます。</p>
        </div>
        <div className="feature-card">
          <span className="feature-icon">📖</span>
          <h3>日本語で解説</h3>
