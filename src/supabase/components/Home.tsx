  ...
  return (
    <div className="home">
      <div className="home-hero">
        ...
        <h1>
          <span className="hero-accent">Supabase BaaS</span>
          入門
        </h1>
        <p className="hero-sub">PostgreSQL、認証、ストレージ、Realtime を統合した BaaS。バックエンドを10レッスンで素早く構築します。</p>
      ...
      <div className="home-features">
        <div className="feature-card">
          ...
          <h3>インタラクティブ</h3>
          <p>認証フローとリアルタイムデータ同期をデモで体験できます。</p>
        </div>
        <div className="feature-card">
          <span className="feature-icon">📖</span>
          <h3>日本語で解説</h3>
