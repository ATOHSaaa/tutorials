  ...
  return (
    <div className="home">
      <div className="home-hero">
        ...
        <h1>
          <span className="hero-accent">WebSocket / Realtime</span>
          入門
        </h1>
        <p className="hero-sub">WebSocket プロトコル、Socket.IO、リアルタイム通信パターンまで。双方向通信を10レッスンで学びます。</p>
