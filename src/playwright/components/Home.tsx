  ...
  return (
    <div className="home">
      <div className="home-hero">
        ...
        <h1>
          <span className="hero-accent">Playwright E2E</span>
          入門
        </h1>
        <p className="hero-sub">ブラウザ自動化、セレクタ、テスト設計、CI 連携まで。信頼性の高い E2E テストを10レッスンで学びます。</p>
      ...
      <div className="home-features">
        <div className="feature-card">
          ...
          <h3>インタラクティブ</h3>
          <p>テスト実行の録画とトレースビューアでデバッグできます。</p>
        </div>
        <div className="feature-card">
          <span className="feature-icon">📖</span>
          <h3>日本語で解説</h3>
