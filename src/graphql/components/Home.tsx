  ...
  return (
    <div className="home">
      <div className="home-hero">
        ...
        <h1>
          <span className="hero-accent">GraphQL API</span>
          入門
        </h1>
        <p className="hero-sub">スキーマ定義、クエリ、ミューテーション、Apollo Client まで。必要なデータだけを取得する API を10レッスンで学びます。</p>
