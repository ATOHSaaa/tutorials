  ...
  return (
    <div className="home">
      <div className="home-hero">
        ...
        <h1>
          <span className="hero-accent">Storybook</span>
          入門
        </h1>
        <p className="hero-sub">コンポーネントカタログの作成、Controls、Docs、テスト連携まで。UI 開発を10レッスンで加速します。</p>
      ...
      <div className="home-features">
        <div className="feature-card">
          ...
          <h3>インタラクティブ</h3>
          <p>コンポーネントのバリエーションをインタラクティブに確認できます。</p>
        </div>
        <div className="feature-card">
          <span className="feature-icon">📖</span>
          <h3>日本語で解説</h3>
