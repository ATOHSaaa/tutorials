  ...
  return (
    <div className="home">
      <div className="home-hero">
        ...
        <h1>
          <span className="hero-accent">Turborepo</span> を
          <br />
          ゼロから学ぶ
        </h1>
        <p className="hero-sub">モノレポのビルドを高速化する Turborepo。タスクのキャッシュと並列実行を10レッスンで学びます。</p>
      ...
      <div className="home-features">
        <div className="feature-card">
          ...
          <h3>インタラクティブ</h3>
          <p>パイプラインとキャッシュの動きをインタラクティブに確認できます。</p>
        </div>
        <div className="feature-card">
          <span className="feature-icon">📖</span>
          <h3>日本語で解説</h3>
