  ...
  return (
    <div className="home">
      <div className="home-hero">
        ...
        <h1>
          <span className="hero-accent">DB 入門</span>を
          <br />
          ゼロから学ぶ
        </h1>
        <p className="hero-sub">
          データベースの仕組みから、テーブル設計・リレーションまで。SQL の前に知っておきたい基礎を10レッスンで学びます。
          環境構築不要、今すぐ始められます。
        </p>
      ...
      <div className="home-features">
        <div className="feature-card">
          ...
          <h3>概念から理解</h3>
          <p>「なぜ DB が必要か」から、設計の考え方まで体系的に学べます。</p>
        </div>
        <div className="feature-card">
          <span className="feature-icon">📖</span>
          <h3>日本語で解説</h3>
          <p>初心者向けにわかりやすく、図解デモも豊富です。</p>
        </div>
        <div className="feature-card">
          <span className="feature-icon">💾</span>
          <h3>進捗を保存</h3>
